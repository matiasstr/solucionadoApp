...
Estado al 2026-09-22: **fases 1 y 2 completas (P0-01, P1-01 a P1-04, P2-01 a P2-03) y P3-01**: catálogo, comercios, historia de precios, seed DEMO, API pública de productos/canónicos/sucursales/precios, motor de promociones simples, y búsqueda + comparación de alternativas por unidad base. Ver ADR 0008 y 0009, y **docs/API.md** (formato estable de las respuestas). Próximo paso: **P3-02 — Pantallas de consumidor (landing, buscador y ficha de producto en `apps/web`)**. Web publicada en https://tusofertas.vercel.app (sin API todavía; el despliegue de la API está bloqueado esperando que el usuario acepte los términos del Marketplace de Vercel para Supabase; ver sección Deploy de CONTINUAR.md).
