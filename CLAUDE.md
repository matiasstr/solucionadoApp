...
Estado al 2026-09-21: **fase 1 completa (P0-01, P1-01 a P1-04) y fase 2 completa (P2-01, P2-02, P2-03)**: catálogo, comercios, historia de precios, unidades y seed DEMO; API pública de productos, canónicos, sucursales y precios actuales; motor de promociones simples y `GET /promotions`. Ver ADR 0008 y 0009, y las secciones de API del README. Próximo paso: **P3-01 — Búsqueda y comparación API con filtros y paginación**. Web publicada en https://tusofertas.vercel.app (sin API todavía; el despliegue de la API está bloqueado esperando que el usuario acepte los términos del Marketplace de Vercel para Supabase; ver sección Deploy de CONTINUAR.md).
